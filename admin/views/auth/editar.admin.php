...
<<<<<<< HEAD
					...
					<div class="container-formulario-img">
						...
						<div class="form-content">
							...
							<!-- id - cedula -->
							<input type="number" placeholder="Cédula" name="id_new" max="999999999999999" min="1000000" required value="<?php echo $fila['id']  ?>" title="Cédula" class="full">
...
<<<<<<< HEAD
							...
							<div class="input-group">
								...
								<!-- password -->
								<input type="password" placeholder="Contraseña Actual" name="password" maxlength="16" minlength="8" required title="Contraseña Actual" class="full" >
